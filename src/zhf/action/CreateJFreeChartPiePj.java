...
import zhf.logic.GhPlanFactLogic;
    ...
    */
    ...
    double aflac_mitsui = GhPlanFactLogic.getGhactualcsRecs("Aflac&Mitsui");
    double sjnk = GhPlanFactLogic.getGhactualcsRecs("SJNK");
    double tmnf = GhPlanFactLogic.getGhactualcsRecs("TMNF");
    double metlife = GhPlanFactLogic.getGhactualcsRecs("MetLife");
